  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore commodi harum tempora possimus laboriosam asperiores amet eaque iure ipsum hic, tenetur dolorem accusamus distinctio, provident enim, inventore delectus odit nihil!
            </p>
            {/* stats */}
